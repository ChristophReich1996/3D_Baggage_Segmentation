...
# Establish a global permutation across testing an training, needed due to dataset construction
# Multiple images of each gun stored in row


class file_permutation():
    def __init__(self):
        self.permute = [1000, 0, 1918, 1115,  139, 1650, 1002, 1906,  519, 1250, 2655,
                        ...
                        2303,  794, 1628, 2696, 1264,  770,  897, 1261, 2192,  774, 1796,
